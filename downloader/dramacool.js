...
DownloaderImpl.prototype.domains = ['www.dramacool.com', 'www.dramacool.tv', 'dramacool.tv', 'dramacooltv.tv', 'www.dramacooltv.tv', 'anime4you.net', 'www.anime4you.net', 'dramatv.co', 'www.dramatv.co', 'dramatv.tv', 'www.dramatv.tv', 'animetv.us', 'www.animetv.us'];
DownloaderImpl.prototype.getDownloadables = function(url, callback) {
	util.getHtml(url, function(html) {
		...
		if(downloadables.length === 0) {
			...
			var downloadUrlBase64 = $('iframe[src*="embeddrama.php"], iframe[src*="newembeddrama.php"], iframe[src*="embed1ads.php"], iframe[src*="embeddramanox.php"]').attr('src');
